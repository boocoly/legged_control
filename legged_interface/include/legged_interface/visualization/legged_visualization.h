...
public:
    ...
    LeggedVisualizer(PinocchioInterface pinocchioInterface, CentroidalModelInfo centroidalModelInfo, ModelSettings modelInfo,
...
private:
    LeggedVisualizer(const LeggedVisualizer&) = default;
